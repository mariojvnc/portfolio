...
namespace DirectoryReadTaskAndBackgroundWorker
{
    ...
    Directory.GetCurrentDirectory() + @"\..\..\..", "directories.csv");
        ...
        private static void GetInfosFromPath(object sender, DoWorkEventArgs e)
        {
            if (paths.Count == 0)
                return;
            ...
            e.Result = $"Finished getting Information of path \"{path}\"";
        ...
        static void Main(string[] args)
        {
            ...
            while (paths.Count > 0)
            {
                ...
                worker.DoWork += GetInfosFromPath;
                worker.DoWork += OnFinish;
        ...
        private static void OnFinish(object sender, DoWorkEventArgs e)
        {
